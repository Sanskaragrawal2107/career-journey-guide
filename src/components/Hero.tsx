        ...
        <div className="text-center">
          <div className="flex flex-col items-center justify-center mb-8">
            <img 
              ...
              className="h-36 mb-4 animate-float"
            />
            <div className="flex justify-center items-center gap-6">
              <Rocket className="h-10 w-10 text-primary animate-float" style={{ animationDelay: '0.5s' }} />
              <Star className="h-8 w-8 text-primary animate-float" style={{ animationDelay: '1s' }} />
              <GraduationCap className="h-10 w-10 text-primary animate-float" style={{ animationDelay: '1.5s' }} />
            </div>
          </div>
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6 animate-fade-in">
            ...
            <Button
              ...
              size="lg"
              className="border-primary text-primary hover:bg-primary-50 text-lg px-8 py-6 h-auto transform transition-all hover:scale-105 group"
            >
          ...
          <div className="mt-16 grid grid-cols-1 gap-4 sm:grid-cols-3 animate-fade-in">
            {[
              ...
              <div 
                key={stat.text} 
                className="glass-card p-8 rounded-lg backdrop-blur-lg hover:bg-primary-50/10 transition-colors"
              >
